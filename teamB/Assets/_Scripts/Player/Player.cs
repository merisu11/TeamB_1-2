...
public class Player : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Oxygyns_get1 = GameObject.FindGameObjectsWithTag("Oxygyn_get.1");//シーン内の獲得した酸素の数を数える
        Oxygyns_get2 = GameObject.FindGameObjectsWithTag("Oxygyn_get.2");//シーン内の獲得した酸素の数を数える
        Oxygyn_get = Oxygyns_get1.Length + Oxygyns_get2.Length;//Oxygyns_getの数を獲得した酸素の数と同一化
